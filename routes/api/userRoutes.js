...
router
  ...
  .update(userController.addFavorites); //this is where they will add favories. We might need to do the samething as with the article scraper where each user has many favories like each article could have many notes
